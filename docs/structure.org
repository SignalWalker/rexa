...
- Vat: A container for objects and an event loop that communicates with other event loops [cite:@lemmer-webberGoblins]. Objects in the same vat are "near" and objects in remote vats are "far".
- Actormap: The object container within a vat.
